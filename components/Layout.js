...
import { AppBar, Toolbar, Typography, Container, Link, ThemeProvider, CssBaseline, Switch, Badge, Button, Menu, MenuItem } from '@material-ui/core';
          ...
          <Toolbar>
            ...
            <NextLink href="/cart" passHref>
              <Link>
                ...
                color="secondary"
                badgeContent = {cart.cartItems.length}>Cart</Badge> : "Cart"}
              </Link>  
            </NextLink>
            {userInfo ? (
            <>
              ...
              className= {classes.navbarButton}>Hello, {userInfo.name}
              </Button>
              <Menu 
              id="simple-menu"
              anchorEl={anchorEl}
